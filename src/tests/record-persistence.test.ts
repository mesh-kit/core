...
describe("Record Persistence System", () => {
  ...
  describe("SQLitePersistenceAdapter with Records", () => {
    let server: MeshServer;
    const port = 8141;
    const dbPath = path.join(testDir, `test-db-${uuidv4()}.sqlite`);
